...
class BrickTrackerROI(Node):
    def __init__(self):
        ...
        # --- HARDCODED SIMULATION INTRINSICS ---
        self.fx = 190.68; self.fy = 190.68; self.cx = 320.0; self.cy = 240.0
        ...
        self.get_logger().info("Brick Tracker: Morphology Closing Enabled.")
    ...
    def seed_callback(self, msg):
        ...
        self.prev_corners = None 
        self.rejection_count = 0
        self.get_logger().info(f"SEED TRIGGER: ({msg.x:.0f}, {msg.y:.0f})")
    ...
    # --- UPDATED: MORPHOLOGICAL CLOSING LOGIC ---
    ...
    def draw_debug_image(self, img, corners, roi_offset, roi_size, accepted):
        ...
        if len(corners) > 0:
            ...
            status = "TRACKING" if accepted else "SEARCHING"
